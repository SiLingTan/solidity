...
/// Given a Solidity type _type, return a Solidity type such that:
/// 1) If _type is supported by the SMT checker, return a copy of _type
/// 2) Otherwise return an abstraction of _type.
//Type abstractType(Type const& _type);
